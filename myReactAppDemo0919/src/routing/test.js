...
var sizeOptions = [{
  ...
  class TableRow extends React.Component{
    ...
    render(){
      // console.log(this.isOdd(this.props.keyYo), "this.isOdd(!this.props.keyYo)")
      // console.log(this.props.orderObj, this.props.keyYo , "orderfff orj in table row is")
      return(
  ...
  class MainContent extends React.Component {
    ...
    getMyOrders() {
     ...
     if(userInput && userInput.length > 0){
        ...
        //console.log(orderObj['size'].includes(userInput) || orderObj['crust'].includes(userInput),"fffff")
        return(orderObj['size'].includes(userInput) || orderObj['crust'].includes(userInput) )
      })
     }
    
    //console.log(myOrders, "myOrdersmyOrders")
  ...
  this.props.handleOpenModal()  
    ...
    getProfile() {
      //console.log(this.props.showProfileModal , "PDOPD")
      return (
    ...
    render() {
      ...
      //console.log(this.state.orderObj, "order is")
      return (
        <div>
        <div>{toReturn}</div>
    </div>)
  ...
  class Application extends React.Component {
      ...
      onSearchInputChange(userInput) {
        ...
        //console.log(userInput, "alsidfjdsf")
  //       if (userInput !== '') {
  //         this.setState({
  //           searchTriggered: true,
  //           showProfileModal: false,
  ...
  React.render(<Application  userName={['Robert','Khayat']} />, document.getElementById('app'));